					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center"><br><br>
								<h4 class="blue" id="id-company-text">&copy; MCQ Test - Admin Panel</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" action="<?= base_url(); ?>admin/admin/login">
											...
											<p><?php echo validation_errors(); ?></p>
												...
												<fieldset>
													...
													<div class="clearfix">
														...
														<button value="loginSubmit" type="submit" class="width-35 center btn btn-sm btn-primary">
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<?= base_url('assets/js/jquery.mobile.custom.minjs'); ?> >"+"<"+"/script>");
		</script>
