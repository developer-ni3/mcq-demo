...
<?php $this->load->view('admin/_layout_head.php'); ?>
	...
	<body class="no-skin">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-block alert-success">
									...
									Welcome to
									<strong class="green">
										MCQ Demo -  Admin Panel
									</strong>, From here you can manage the entire website.
								</div>
								...
								<div class="row">
									...
									<div class="col-sm-12 infobox-container">
										<a href="<?= base_url('admin/user') ?>" class="infobox infobox-green">
		...
		<script src="<?= base_url('assets/admin/js/jquery.sparkline.index.min.js'); ?>"></script>
