					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<a href="<?= base_url('home/logout'); ?>" class="btn btn-info" type="submit">
											<i class="ace-icon fa fa-check bigger-110"></i>
											Start New
                                </a>
								<span style="float:right">Welcome, <?= $this->session->userdata('user_name'); ?> </span>
								<?php //print_r($this->session->userdata('correct_values')); ?>

								<?php $this->load->view('admin/_layout_alert.php'); ?>
							</h1>
						</div><!-- /.page-header -->

						<?php //print_r($submitted_data); die;
						 
						if($submitted_data != false) { ?>
							<h1 class="center">Score - <?= $submitted_data->correct_cnt ?> / 10 </h1>
							<h4 class="center">Appeared On - <?= $submitted_data->submitted_on ?> </h4>
						<?php }else{  ?>

						<div class="row">
							<form class="form-horizontal" role="form" action="<?= base_url('home/start'); ?>" method="post" enctype="multipart/form-data">
								
									<?php //echo "<pre>"; print_r($question_data); 
										$sr_no = 0; 
										?>
									<?php foreach ($question_data as $questions) { ?>
									<label class="col-sm-12"> <b><?= $sr_no+1 . " - " . $questions->question; ?></b> </label><?php $sr_no-1; ?>
									<div class="col-sm-12">
										<?php foreach ($questions->incorrect_answers as $inc_ans) { ?>
										<input type="radio" id="<?= $sr_no ?>" name="<?= $sr_no ?>" value="<?= $inc_ans; ?>">
										<label for="<?= $inc_ans; ?>"><?= $inc_ans; ?></label> &nbsp;
										<?php } ?>
									</div>
								...
								<div class="">
									<div class="col-md-offset-3 col-md-9">
										<button onclick='return confirm("Are You Sure?")' class="btn btn-info" type="submit">Submit Test
										</button>	
									</div>
								</div>
							</form>
