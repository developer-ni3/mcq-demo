...
.products-area.three1 h2
{
	color:#000;
}
.products-area.three1 span
{
	color:#000;
	font-weight:400;
}
...
.products-area.three1 .default-btn.three
{
	color:#000;
	border: 1px solid #000;
}
.products-area.three1 .products-content {
    max-width: 585px;
    margin-right: auto;
}
.products-area.three1 .products-content span {
    color: #000;
	font-weight:400;
}
.products-area.three1 .products-content h2 {
    color: #000;
	font-family: roboto condensed, sans-serif !important;
}
.products-area.three1 .products-content p {
    color: #000;
}
.products-area.three1 .products-content p::before {
    background-color: #000;
}
.products-area.three1 .thumbs-wrap {
    top: 450px;
    max-width: 368px;
    -webkit-transform: rotate(90deg);
    transform: rotate(90deg);
...
.products-area.three1 .thumbs-wrap .owl-thumb-item::before {
    background-color: #676a6a;
}
.products-area.three1 .thumbs-wrap .owl-thumb-item::after {
    background-color: #676a6a;
}
.products-area.three1 .thumbs-wrap .owl-thumb-item span {
    position: relative;
}
.products-area.three1 .thumbs-wrap .owl-thumb-item span::before {
    content: "";
    position: absolute;
    top: -63px;
    left: 0;
...
.products-area.three1 .thumbs-wrap .owl-thumb-item:hover span {
    color: #000;
    -webkit-transition: all 0.5s;
    transition: all 0.5s;
}
.products-area.three1 .thumbs-wrap .owl-thumb-item:hover span::before {
    -webkit-transform: scale(1);
    transform: scale(1);
}
.products-area.three1 .thumbs-wrap .owl-thumb-item:hover::before {
    background-color: #e2a750;
}
.products-area.three1 .thumbs-wrap .owl-thumb-item:hover::after {
    background-color: #e2a750;
}
.products-area.three1 .thumbs-wrap .owl-thumb-item.active span {
    color: #000;
}
.products-area.three1 .thumbs-wrap .owl-thumb-item.active span::before {
    -webkit-transform: scale(1);
    transform: scale(1);
}
.products-area.three1 .thumbs-wrap .owl-thumb-item.active::before {
    background-color: #e2a750;
}
.products-area.three1 .thumbs-wrap .owl-thumb-item.active::after {
    background-color: #e2a750;
}
.products-area.three1 .owl-prev {
    top: 25px;
    left: 73px;
    right: 0;
    margin: auto !important;
...
.image_set_blog_main {
    ...
    <style>
        ...
        <script async src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.5.3/jspdf.min.js"></script>
    </head>
    <body>
        <div class="navbar-area">
            <div class="main-nav">
                <div class="container-fluid">
                    <div class="col-md-12 ppt-30">
                        <center>
                            <a class="navbar-brand" href="<?= base_url(); ?>">
                            <img src="<?= base_url('assets/frontend/img/logo.png'); ?>" alt="Logo" style="width: 70%;">
                            </a>
                        </center>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3">
                                <ul class="social-wrap">
                                    ...
                                    <li>
                                        <a href="https://wa.me/?text=<?= current_url(); ?>" target="_blank">Share 
                                        <i class="bx bxs-share"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <button onclick="printDiv('pnk');">Download
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-12">
                        <div class="product-details-image">
                            <img src="<?= base_url('uploads/'.$row->thumb_url); ?>" alt="Image" class="popup-youtube">
                        </div>
                    </div>
                    <div class="col-lg-9 col-md-12">
                        <div class="product-details-desc">
                            ...
                            //     } else {  
                            //         echo "<br/>Cookie Value: " . $_COOKIE["wishlist"];  
                            //     }  
                            ?>
                            <!-- <p><?= $row->profile; ?></p> -->
                            <p>Aditi A (born 21 May 1976) is an Indian model, actress and a doctor. From 1997 until 2004, She remains the only Indian supermodel with the both medical doctor and psychologist qualification. She has been touted by Hindustan Times as "Beauty with Brains". She is a vegetarian and ardent Vipassana practitioner.
                                <br>
                                She won the Gladrags Megamodel Contest in 1996 and the Gladrags Mrs. India in 2000, subsequently winning Mrs. World contest in 2001. She remains the first and the only Indian woman to have won the Mrs. World title.<br><br>
                            </p>
                            <p>
                        ...
                        <div class="tags-and-shear-wrap artfollow">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <ul class="social-wrap">
                                        ...
                                        <li>
                                            <a href="<?= $row->follow_tw; ?>" target="_blank">
                                            <i class="bx bxl-twitter"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= $row->follow_insta; ?>" target="_blank">
                                            <i class="bx bxl-instagram"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= $row->follow_fb; ?>" target="_blank">
                                            <i class="bx bxl-facebook"></i>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?= $row->follow_ytb; ?>" target="_blank">
                                            <i class="bx bxl-youtube"></i>
                                            </a>
                                        </li>
                                        <li style="margin-left:30px;">
                                            <a href="#" target="_blank">View Profile
                                            <i class="bx bxs-download"></i>
                                            </a>
                                        </li>
                                        <li style="margin-left:30px;">
                                            <?php if(isset($_COOKIE["wishlist2"])) { 
                                            $myString = $_COOKIE["wishlist2"];
                                            $myArray = explode(',', $myString);
                                            if(in_array($row->id,$myArray)){ ?>
                                            Added
                                            <i class="bx bxs-download"></i>
                                            <?php } else {?>
                                            <a href="javascript:void(0);" id="<?= $row->id; ?>" class="wishlist">Shortlist
                                            <i class="bx bxs-download"></i>
                                            </a>
                                            <?php } } else{ ?>
                                                <a href="javascript:void(0);" id="<?= $row->id; ?>" class="wishlist">Shortlist
                                        ...
                                        <li style="margin-left:30px;">
                                            <a href="#" data-toggle="modal" data-target="#myModal">Book Now
                                            <i class="bx bxs-download"></i>
                                            </a>
                                        </li>
                                    </ul>
        ...
        <section id="nnk" class="portfolio-area" style="margin-top:0px;padding-bottom:100px;">
            <div class="container">
                <div class="portfolio-wraps">
                    <div class="row" style="padding: 12px;">
                        <?php foreach($images as $row){ ?>
                        <div class="col-lg-4 col-md-6 mix certified">
                            <div class="ingle-team">
                                <div class="">
                                    <?php 
                                    //$url = base_url('uploads/'.$row->image_url);
                                    $url = $row->image_url; 
                                    ?>
                                    <a href="<?= $url; ?>" class="popup-img"><img src="<?= $url; ?>" alt="Image"></a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
        ...
        <form id="abc" action="<?= base_url($city.'/artist/mypdf3'); ?>" method="post">
                            
                                    <input type="hidden" value="" name="pdf_data" id="pdf_data">
...
<button id="cmd">Generate PDF</button>
        <script>
            function create_pdf(){
                //alert();
                //$("#table_html").css("display", "block");
                //var html = $("#deva").html();
                var html =  document.getElementById("deva").innerHTML; 
                document.getElementById('pdf_data').value = html;
...
<script src="<?= base_url('assets/frontend/js/jquery-3.5.1.slim.min.js'); ?>"></script>
        ...
        <script src="<?= base_url('assets/frontend/js/carousel-thumbs.js'); ?>"></script>
        ...
        <script src="<?= base_url('assets/frontend/js/odometer.min.js'); ?>"></script>
